...
# 所有日志自动保存到 ./KissFeng/ccplugin/log/YYYYMMDDHH.log
```
...
```bash
# 查看最新日志文件
tail KissFeng/ccplugin/log/2026012114.log

# 实时跟踪日志
tail -f KissFeng/ccplugin/log/2026012114.log

# 查看所有日志
cat KissFeng/ccplugin/log/*.log
```
...
A: `./KissFeng/ccplugin/log/` - 相对于当前工作目录。
...
A: 当前默认位置固定为 `./KissFeng/ccplugin/log/`。如需改变，请修改 `RichLoggerManager` 中的 `log_dir` 配置。
