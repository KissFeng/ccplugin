# cortex-memory — CRUD 详细流程

> SKILL.md 入口的 read / write / update / delete 4 verb 详细行为 + URI 解析 + frontmatter 自动填。
...
4. **不**更新 `recall_count` (该字段由 cortex-search recall 子流程维护, read 是直接寻址)
