...
3. **选目录 (按 prd §3.2.7 + preset)**
   ...
   | ------------------------- | ------------------------ | ---------------------------- | -------------------------------- |
   | source (URL / 文章, 非 repo) | `知识库/来源/网页/<host>/<kebab>.md` (arxiv → `知识库/来源/论文/<kebab>.md`; 书 → `知识库/来源/书籍/<kebab>.md`) | `references/<UID>-<slug>.md` | `3_resources/sources/<kebab>.md` |
   | concept (新概念页)        | `知识库/概念/<kebab>.md` | `zettels/<UID>-<slug>.md`    | `3_resources/<topic>/<kebab>.md` |
   | entity (人/工具/项目对象) | 若属于某 repo → `知识库/项目/<host>/<org>/<repo>/<entity-kebab>.md`; 否则独立 → `知识库/概念/<kebab>.md` | `zettels/<UID>-<entity>.md`  | `2_areas/<area>/<kebab>.md`      |
   | git repo (github/gitlab/local) | `知识库/项目/<host>/<org>/<repo>/_index.md` + `{架构,决策,陷阱,依赖}.md` + `笔记/` + `决策/` | `references/<UID>-<repo>.md` | `1_projects/<repo>/` |
...
按 URL/file 判定 source_kind. **repo (github/gitlab/local git)** 走 **kind=project** 路由, 落 `知识库/项目/<host>/<org>/<repo>/`;其他非 repo 来源落 `知识库/来源/<kind>/`。调 cortex-schema `read <target-path>` 取 schema 填 frontmatter (host/domain/year/author 等), 加 tags_required (含 host/domain/year 实际值替代 placeholder)。例:
...
- 网页 URL → `知识库/来源/网页/<host>/<slug>.md`, tags: [source/web, host/<host>, domain/<domain>]
- arxiv/doi → `知识库/来源/论文/<slug>.md`, tags: [source/paper, year/<year>]
- 书籍 → `知识库/来源/书籍/<slug>.md`, tags: [source/book]
...
| 本地 git 仓库 (origin 非 github/gitlab) | `知识库/项目/local/<basename>/_index.md` + 同上子文档 |
| 项目 (无 git, 含 pyproject/package.json/Cargo.toml/go.mod) | `知识库/项目/local/<basename>/_index.md` + 子文档 |
