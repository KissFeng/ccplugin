...
<section data-role="tag-cloud" style="display:flex;gap:6px;flex-wrap:wrap;margin:12px 0">
  <!-- cortex-dashboard 注入 related_domains 标签 -->
  {{TAG_CLOUD}}
</section>
...
<details open>
<summary>按 type=insight 过滤</summary>
