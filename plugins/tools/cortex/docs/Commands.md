...
| `/cortex:dashboard` | 📚 | 刷新仪表盘 | 重渲 `index.md` / `hot.md` / canvas |
| `/cortex:fold` | 📚 | 折叠 | 长 log/ledger 切尾到 `folds/<YYYY-QN>.md` |
| `/cortex:compact` | 📚 | 紧凑 | 整理 vault, 删空目录, 合并碎片 |
| `/cortex:warden` | 📚 | 守卫巡检 | 周期扫孤儿 / 死链 / 老 fleeting, 自动处理 |
