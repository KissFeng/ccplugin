...
- `cortex-plugin-2026-05-13.md` — **@cortex 当前真相** (vault 4 子目录 / 6 agent / 16 skill (含多模态理解三件套 image/video/audio-understand 2026-05-22) / 19 slash / 27 wrapper / 15 py CLI (image/video/audio_understand + 共享 _provider_common.http_multipart) / 30 lint / 4 cron / MCP 写 + 搜索回退链 / 评分字段 4+2 / 记忆 L0-L4 / digest stage 5 双向桥 + bridge.jsonl 审计)
